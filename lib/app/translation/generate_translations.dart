...
// You can run it from .vscode/tasks.json
// https://docs.google.com/spreadsheets/d/1DcSEZFramF1mNeZ3306x9bl36fw1SoqHFBnBrebRpiE/edit#gid=0
void main() {
...
Future updateLocalizationFile() async {
  ...
  String documentId = "1DcSEZFramF1mNeZ3306x9bl36fw1SoqHFBnBrebRpiE";
  //the sheetid of your google sheet
  String sheetId = "0";

  String _phraseKey = '';
  List<LocalizationModel> _localizations = [];
  String _localizationFile = """// ignore_for_file: equal_keys_in_map
